...
export async function POST(req: NextRequest) {
  try {
    ...
    // 5. Tentukan tab bulan sesuai request_date (tanggal entry-nya, BUKAN
    //    created_at — supaya kalau entry di-edit di hari lain, tanggal
    //    entry aslinya tetap dipakai), duplikat dari TEMPLATE SR kalau
    //    tab bulan itu belum ada. Duplicate = rumus ikut persis, tidak
    //    ada yang diubah.
