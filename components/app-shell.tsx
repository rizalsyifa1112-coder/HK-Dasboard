...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'laundry', label: 'Laundry', href: '/laundry', icon: Shirt, group: 'Operations' },
  { key: 'linen-tracking', label: 'Linen Tracking', href: '/linen-tracking', icon: Layers, group: 'Operations' },
